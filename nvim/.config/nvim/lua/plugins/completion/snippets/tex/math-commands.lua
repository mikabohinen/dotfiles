...
local auto_backslash_snippet = require("plugins.completion.snippets.tex.utils.scaffolding").auto_backslash_snippet
local symbol_snippet = require("plugins.completion.snippets.tex.utils.scaffolding").symbol_snippet
local single_command_snippet = require("plugins.completion.snippets.tex.utils.scaffolding").single_command_snippet
local postfix_snippet = require("plugins.completion.snippets.tex.utils.scaffolding").postfix_snippet
...
local symbol_specs = {
	...
	["O+"] = { context = { name = "⨁" }, command = [[\bigoplus]] },
	["Ox"] = { context = { name = "⨂" }, command = [[\bigotimes]] },
	-- sets
